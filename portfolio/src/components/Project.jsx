...
import { Badge, Button, Card, CardBody, CardText, CardTitle, Col, Container, Row } from 'react-bootstrap';
...
function Projects() {
    ...
    },
    {
      ...
      live: 'murugasutha.github.io/FitnessKit/'
    },
    {
      title: 'Paisa Planner',
      image: 'https://via.placeholder.com/400x200?text=Doemart',
      ...
      live: 'murugasutha.github.io/paisaPlanner/'
    },
    {
                ...
                <Container>
                    ...
                    <Row className='g-2 mb-5'>
                        {projectList.map((project, index) => (
                            <Col key={index} md={4} sm={6} xs={12} data-aos="fade-up" data-aos-duration={1200 + index}>
                                    <Card className='h-100 p-1 border-0 rounded-circle education-card' style={{background: '#f0d3d3'}}> 
